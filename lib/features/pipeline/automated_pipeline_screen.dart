...
class AutomatedPipelineScreen extends ConsumerWidget {
  const AutomatedPipelineScreen({super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Community Collection', style: HermesTypography.screenTitle.copyWith(fontSize: 20)),
        centerTitle: true,
      ),
      body: SafeArea(
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              Text('Discover Topics', style: HermesTypography.sectionTitle),
              const SizedBox(height: HermesSpacing.xs),
              Text('Subscribe to community topics and automatically download knowledge.', style: HermesTypography.metadata),
